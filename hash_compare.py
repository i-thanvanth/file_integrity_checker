...
pygui.theme('reddit')
layout = [[pygui.T("Hello, Welcome to T's hash checker app")], [pygui.Text("Choose the file: "), pygui.Input(), pygui.FileBrowse(key="-path-")],[pygui.Text("Enter the hash: "), pygui.Input(key="-hash-")],
